...
-- |
-- Module      : Builder.Applicator.ShotgunModApplicator
...
module Builder.Applicator.ShotgunModApplicator where
...
--   generates list of function from given indices
...
listOfMods wep = snd <$> shotgunModsMetaList wep
