...
printComprehensiveMelee :: ComprehensiveWeapon -> Box
printComprehensiveMelee cw = vcat
  left
  [ hcat
    left
 ...
 where
  ...
  sGeneralInformation = vcat
    ...
    , text "Charge Attack      "
      <+> text (formatFloatN $ fromMaybe 0.000 $ gw ^. gwChargeAttack)
    , text "Spin Attack        "
      <+> text (formatFloatN $ fromMaybe 0.000 $ gw ^. gwSpinAttack)
    , text "Leap Attack        "
      <+> text (formatFloatN $ fromMaybe 0.000 $ gw ^. gwLeapAttack)
    , text "Wall Attack        "
      <+> text (formatFloatN $ fromMaybe 0.000 $ gw ^. gwWallAttack)
    ]
